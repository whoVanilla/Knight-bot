...
client.on('messageCreate', message => {
    ...
    try {
        ...
        console.log(`\x1b[1m\x1b[33m${message.author.username}\x1b[0m executed the \x1b[1m\x1b[91m!${command.name}\x1b[0m command in \x1b[1m\x1b[36m${message.guild.name}\x1b[0m.`);
    } catch (error) {
